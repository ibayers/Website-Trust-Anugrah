...
export default function GensetPage() {
  return (
    <PageShell
      ...
      heroTitle={
        <>
          Uninterrupted <span className="text-secondary">Precision</span>{" "}
          Energy.
        </>
      }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
          <GlassCard className="lg:col-span-7 p-8">
            ...
            <p className="text-body-lg text-on-surface-variant leading-relaxed mb-4">
              ...
              electrical generator (often called an alternator) to generate
              electrical energy. Diesel generating sets are used in places
              without connection to the power grid or as emergency power-supply
              if the grid fails.
            </p>
            <p className="text-on-surface-variant leading-relaxed">
              We provide rental services, repairs, and maintenance for various
              brands such as Mitsubishi, Nissan, etc. Genset is needed for tower
              crane and passenger hoist.
            </p>
      ...
      <section className="px-margin-desktop py-section-gap">
        <GlassCard className="p-12 text-center">
          <h2 className="font-headline-lg text-headline-lg text-on-surface mb-4">
            Request genset rental
          </h2>
          <p className="text-on-surface-variant text-body-lg mb-8 max-w-2xl mx-auto">
            Capacity, type (open/silent), and duration — we will match the right
            unit and crew.
          </p>
          <ContactCTA
