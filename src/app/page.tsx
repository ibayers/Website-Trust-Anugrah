  ...
  const equipment = [
    {
      ...
      title: "Tower Crane",
      desc: "Potain, Raimondi, Jianglu, QT80, Peinner.",
    },
    {
      href: "/passenger-hoist/",
      icon: "elevator",
      title: "Passenger Hoist",
      desc: "80–100 m height rental capabilities.",
    },
    {
      href: "/material-lift/",
      icon: "forklift",
      title: "Material Lift",
      desc: "Single & double configurations.",
    },
    {
      href: "/manual-crane/",
      icon: "construction",
      title: "Manual Crane",
      desc: "Low-cost dismantling alternative.",
    },
    // { href: '/genset/', icon: 'bolt', title: 'Generator Set', desc: '150–250 kVA Mitsubishi & Nissan.' },
    {
      ...
      icon: "shopping_cart",
      title: "Sell",
      desc: "New MG5023 / MG6015 / MG6036 / MG7030.",
    },
  ] as const;
    ...
    >
          ...
          {coreBusiness.map((pillar, i) => {
            ...
            return (
              <GlassCard key={pillar} className="p-6">
                ...
                <p className="mt-3 font-headline-md text-body-lg text-on-surface font-semibold">
                  {pillar}
                </p>
                {desc && (
      ...
      <section className="px-margin-desktop py-section-gap">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-gutter">
          {services.map((svc) => (
            <GlassCard
              key={svc.id}
              className="p-8 group hover:border-secondary/50 transition-all duration-500"
            >
              <div className="flex justify-between items-start mb-8">
                ...
                <span className="font-label-technical text-outline opacity-40">
                  {svc.id}
                </span>
              </div>
              ...
              <div className="space-y-3 border-t border-outline-variant/30 pt-6">
                {svc.specs.map(([k, v]) => (
                  <div
                    key={k}
                    className="flex justify-between items-center text-xs font-label-technical"
                  >
        ...
        <div className="grid grid-cols-12 gap-gutter h-auto lg:h-[640px]">
          ...
          <div className="col-span-12 lg:col-span-8 relative overflow-hidden glass-panel rounded-xl group">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex flex-col justify-end p-12">
              <span className="font-label-technical text-tertiary mb-2">
                FEATURED EQUIPMENT
              </span>
              ...
              <p className="text-on-surface-variant max-w-xl mb-6">
                Built for Jakarta&apos;s skyline. Potain, Raimondi, Jianglu,
                QT80 — erection, dismantling, parts, and certified operators.
              </p>
              <Link
                href="/tower-crane/"
          ...
          <div className="col-span-12 lg:col-span-4 flex flex-col gap-gutter">
            <GlassCard className="flex-1 p-8">
              <h4 className="font-label-technical text-secondary mb-6">
                VERIFIED PROFILE
              </h4>
      ...
      <section className="px-margin-desktop py-section-gap relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <span className="font-label-technical text-secondary tracking-widest block mb-4">
            OUR PHILOSOPHY
          </span>
          ...
          <div className="flex justify-center gap-12">
            ...
            <div>
              ...
              <div className="font-label-technical text-outline">
                EQUIPMENT LINES
              </div>
            </div>
          </div>
      ...
      <section className="px-margin-desktop py-section-gap">
        <GlassCard className="p-12 text-center">
          ...
          <p className="text-on-surface-variant text-body-lg mb-8 max-w-2xl mx-auto">
            Request a quote, schedule a service, or ask about parts
            availability.
          </p>
          <ContactCTA
