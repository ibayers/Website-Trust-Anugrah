...
export default function ManualCranePage() {
  return (
    ...
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          <GlassCard className="md:col-span-8 p-10">
            ...
            <p className="font-body-lg text-body-lg text-on-surface-variant leading-relaxed mb-8">
              In modern urban construction, spatial constraints often render standard mobile cranes obsolete. Manual
              cranes are needed to dismantle tower cranes from difficult areas that small mobile cranes cannot
              approach. Our engineered systems bridge this gap, offering a low-cost, high-reliability alternative
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {mcUseCases.map((u) => (
                <div key={u.title} className="flex gap-4 items-start">
                  ...
                  <div>
                    <h4 className="font-bold text-on-surface mb-1 uppercase tracking-tight">{u.title}</h4>
          ...
          <GlassCard className="md:col-span-4 bg-surface-container-high p-8 flex flex-col justify-between">
            <div>
              <h3 className="font-label-technical text-secondary mb-4">DEPLOYMENT METRICS</h3>
              <div className="space-y-4">
                {mcSpecs.map((s) => (
                  <div key={s.label} className="flex justify-between border-b border-outline-variant/10 pb-2">
      ...
      <section className="px-margin-desktop py-section-gap">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-gutter">
          <GlassCard className="p-8">
            <h2 className="font-headline-md text-headline-md text-on-surface mb-4">Rental</h2>
            <p className="text-body-lg text-on-surface-variant leading-relaxed">
              For some reason, manual cranes are needed to dismantle tower cranes from difficult areas where small
              mobile cranes cannot get close to the tower crane. We can use a manual crane just like a tower crane,
              with lower cost.
            </p>
          </GlassCard>

          <GlassCard className="p-8">
            <h2 className="font-headline-md text-headline-md text-on-surface mb-4">Design &amp; manufacture</h2>
            <p className="text-body-lg text-on-surface-variant leading-relaxed">
              Beside rental manual crane to our client, our engineers have been designing and manufacturing manual
              cranes too. Custom configurations available — share your site constraints with us.
            </p>
          </GlassCard>
        </div>
      </section>
      ...
      <section className="px-margin-desktop py-section-gap">
        <div className="mb-12">
          <h2 className="font-headline-lg text-headline-lg mb-4">Field Deployments</h2>
          <div className="w-24 h-1 bg-secondary" />
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[
            { src: '/images/design/manual-crane/03.jpg', label: 'Rigging setup' },
            { src: '/images/design/manual-crane/04.jpg', label: 'Structural anchor' },
            { src: '/images/design/manual-crane/05.jpg', label: 'Lift operation' },
            { src: '/images/design/manual-crane/06.jpg', label: 'Compact footprint' },
            { src: '/images/design/manual-crane/07.jpg', label: 'Dismantling sequence' },
            { src: '/images/design/manual-crane/08.jpg', label: 'Component detail' },
            { src: '/images/design/manual-crane/09.jpg', label: 'Site integration' },
            { src: '/images/design/manual-crane/01.jpg', label: 'Hero unit' },
            { src: '/images/design/manual-crane/02.jpg', label: 'Deployment detail' },
          ].map((p, i) => (
            <div
              key={p.src + '-' + i}
      ...
      <section className="px-margin-desktop py-section-gap">
        <GlassCard className="p-12 text-center">
          ...
          <p className="text-on-surface-variant text-body-lg mb-8 max-w-2xl mx-auto">
            We will propose either a rental unit or a custom-manufactured manual crane.
          </p>
          <ContactCTA
