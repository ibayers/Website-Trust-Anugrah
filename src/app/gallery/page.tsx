...
const galleryItems: {
  ...
  },
  {
    ...
    icon: "construction",
    title: "Manual Crane Deploy",
    tag: "FIELD SERVICE",
    filter: "FIELD_SERVICE",
  },

  {
    src: "/images/A1 CRANE.jpg",
    icon: "verified",
    title: "Verified Unit",
    tag: "CERTIFIED",
    filter: "TOWER_CRANES",
  ...
  },
  {
    ...
    icon: "elevator",
    title: "Dual Cage Hoist",
    tag: "VERTICAL TRANSPORT",
    filter: "PASSENGER_HOIST",
  },
  {
    src: "/images/design/passenger-hoist/feature-04.jpg",
    icon: "height",
    title: "High-Rise Hoist Deploy",
    tag: "OPERATIONS",
    filter: "PASSENGER_HOIST",
  },
];
...
export default function GalleryPage() {
  ...
  const items = galleryItems.filter(
    (it) => active === "ALL" || it.filter === active,
  );
  ...
  return (
    <PageShell
      ...
      heroTitle={
        <>
          Visualizing <span className="text-secondary">Precision</span> in
          Motion.
        </>
      }
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
          ...
          <div className="flex gap-4">
            <GlassCard className="p-6 flex flex-col items-center">
              <span className="font-display-xl text-headline-lg text-secondary">
                1985
              </span>
              <span className="font-label-technical text-xs">
                EXPERIENCED SINCE
              </span>
            </GlassCard>
            <GlassCard className="p-6 flex flex-col items-center">
              <span className="font-display-xl text-headline-lg text-primary">
                5
              </span>
              <span className="font-label-technical text-xs">
                EQUIPMENT LINES
      ...
      <section className="px-margin-desktop py-section-gap">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gutter">
          ...
          {showFlagship && (
            <GlassCard className="lg:col-span-2 lg:row-span-2 relative group overflow-hidden cursor-pointer p-0">
              ...
              <div className="absolute bottom-0 left-0 p-8 w-full">
                ...
                <h3 className="font-headline-md text-body-lg font-bold mb-2">
                  {flagshipItem.title}
                </h3>
          ...
          {items.map((item) => (
            <GlassCard
              key={item.src}
              className="relative group overflow-hidden cursor-pointer p-0"
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src={item.src}
            ...
            <div className="max-w-3xl space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-gutter py-8">
                <div className="border-l-2 border-secondary pl-6">
                  <h4 className="font-label-technical text-secondary mb-2">
                    FOUNDATION
                  </h4>
                  <p className="text-sm">
                    CV established October 9, 1993. Incorporated as PT on
                    October 13, 1998.
                  </p>
                </div>
                <div className="border-l-2 border-primary pl-6">
                  <h4 className="font-label-technical text-primary mb-2">
                    EXPERTISE
                  </h4>
                  <p className="text-sm">
                    Many years of experience in particular construction of tower
