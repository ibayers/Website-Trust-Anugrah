...
export default function PassengerHoistPage() {
  return (
    <PageShell
      ...
      heroImage="/images/design/passenger-hoist/dual-cage.jpg"
    >
      ...
      <section className="px-margin-desktop py-section-gap">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-gutter mb-12">
          <div className="max-w-2xl">
            <h2 className="font-headline-lg text-headline-lg mb-4">Operational Profile</h2>
            <p className="text-on-surface-variant text-body-lg">
              Vertical transport engineered for the tallest skylines, with verified 80-100m height capability and
              redundant safety systems.
            </p>
          </div>
          <div className="flex flex-col items-end gap-2 text-right">
            <span className="font-label-technical text-on-surface-variant">OPERATIONAL CAPACITY</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          ...
          <GlassCard className="md:col-span-8 h-[400px] relative overflow-hidden group">
            ...
            <img
              src="/images/design/passenger-hoist/dual-cage.jpg"
            ...
            <div className="absolute bottom-8 left-8">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-label-technical text-sm text-on-surface">UNIT ID: PH-T100-26</span>
              </div>
          ...
          <div className="md:col-span-4 flex flex-col gap-gutter">
            <GlassCard className="p-0 overflow-hidden flex flex-col">
              <div className="aspect-[4/3] overflow-hidden">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/images/design/passenger-hoist/vfd.jpg"
              ...
              <div className="p-6">
                <h4 className="font-headline-md text-lg mb-2">Precision Control</h4>
            ...
            <GlassCard className="p-0 overflow-hidden flex flex-col">
              ...
              <div className="p-6">
                <h4 className="font-headline-md text-lg mb-2">Service Lifecycle</h4>
                <p className="text-on-surface-variant text-sm">
      ...
      <section className="bg-surface-container-low/40 py-section-gap">
        <div className="px-margin-desktop">
          <h2 className="font-headline-lg text-headline-lg mb-12">
            Our Rental &amp; Service <span className="text-tertiary">Commitment</span>
          </h2>
      ...
      <section className="px-margin-desktop py-section-gap">
        <GlassCard className="p-12 text-center">
          <h2 className="font-headline-lg text-headline-lg text-on-surface mb-4">Schedule hoist rental</h2>
          <p className="text-on-surface-variant text-body-lg mb-8 max-w-2xl mx-auto">
            Share site details and required height; we will propose the right unit.
          </p>
          <ContactCTA
